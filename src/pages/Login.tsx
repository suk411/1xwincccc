    ...
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="relative z-10 flex flex-col flex-1 px-5  pt-6">
        ...
        <div className="flex items-center justify-center gap-4 mt-6">
          <button className="flex items-center gap-1.5 text-[#c4889a] text-xs border border-[#5a2030] rounded-full px-4 py-1.5" onClick={() => window.open("https://tawk.to/chat/69ba6f55bb7f0b1c337b2956/1jk045qmh", "_blank")}>
