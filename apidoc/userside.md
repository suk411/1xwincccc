...
**Notes:**
- One document per user — all payment types stored together
- Each type has its own sub-object (`bank`, `upi`, `upay`)
- Calling the endpoint again with a different type updates just that sub-object without affecting others
